...
public interface IEnumerableValidator<out TFact, out TType>
{
    ...
    /// <summary>
    /// Gets the name of the enumerable property being validated.
    /// </summary>
    string PropertyName { get; }


    /// <summary>
    /// Adds a condition that must be true for the enumerable to be considered valid.
    /// </summary>
    /// <param name="condition">A function that receives the fact and the extracted enumerable and returns <c>true</c> if valid.</param>
    ...
    /// <summary>
    /// Adds a condition that must be false for the enumerable to be considered valid.
    /// </summary>
    /// <param name="condition">A function that receives the fact and the extracted enumerable and returns <c>true</c> for the negated condition.</param>
    /// <returns>This validator instance for fluent chaining.</returns>
